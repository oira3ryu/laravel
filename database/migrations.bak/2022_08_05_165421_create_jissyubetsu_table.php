...
class CreateJissyubetsuTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('jissyubetsu', function (Blueprint $table) {
            $table->bigIncrements('jissyubetsu_id'); // 主キー
...
on update CURRENT_TIMESTAMP')); // 更新日付
    ...
    {
        Schema::dropIfExists('jissyubetsu');
    }
}
