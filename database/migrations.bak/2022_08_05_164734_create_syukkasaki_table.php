...
class CreateSyukkasakiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('syukkasaki', function (Blueprint $table) {
            $table->bigIncrements('syukkasaki_id'); // 主キー
            $table->unsignedInteger('koujyou_id'); // 工場ID  
    ...
    {
        Schema::dropIfExists('syukkasaki');
    }
}
