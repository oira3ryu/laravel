...
class CreateYobikyoudoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('yobikyoudo', function (Blueprint $table) {
            $table->bigIncrements('yobikyoudo_id'); // 主キー
...
on update CURRENT_TIMESTAMP')); // 更新日付
    ...
    {
        Schema::dropIfExists('yobikyoudo');
    }
}
